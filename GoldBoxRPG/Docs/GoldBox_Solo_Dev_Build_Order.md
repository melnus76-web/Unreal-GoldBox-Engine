...
| 40 | **GB-037** | Multiple attacks — Threshold System breakpoints (Warden 1→2→2+reroll at L5/L8, Rogue/Devout 1→2 at L8, Adept always 1). No fractional/partial-round tracking, no Sweep Attack subsystem (dropped) |
